...
//Beneath this comment: querySelel
...
function sendApiRequest(searchedFor) {
  
    fetch("https://api.giphy.com/v1/gifs/search?api_key=HNqKNfChPEIi0N5X0gypxTNkOmysUHIY&q="+searchedFor+"&limit=25&offset=0&rating=G&lang=en")
    .then(function(data) {
      return data.json();
    })
    .then(function(json) {
